...
where dbid in (db_id('MD360Gate'),db_id('MD360GlobalDB'),db_id('AlamedaDB'),db_id('HarrisDB'),db_id('ParklandDB'),db_id('AlamedaDoctorDB'),db_id('ParklandDoctorDB'),db_id('HarrisNurseDB'),db_id('ParklandNurseDB')) and cmd = 'AWAITING COMMAND' and spid <> @@spid;
exec(@sql);
end;
go
...
insert into PdbClinics (ClinicId,Name,ClinicNumber) values (4,'Adventist','004');
insert into PdbClinics (ClinicId,Name,ClinicNumber) values (5,'Carolinas','005');
insert into PdbClinics (ClinicId,Name,ClinicNumber) values (6,'Mayo','006');
...
insert into PdbMedicines (ClinicId,Name) values (4,'Xanax');
insert into PdbMedicines (ClinicId,Name) values (4,'Zoloft');
insert into PdbMedicines (ClinicId,Name) values (4,'Celexa');
insert into PdbMedicines (ClinicId,Name) values (4,'Prozac');
insert into PdbMedicines (ClinicId,Name) values (4,'Ativan');
insert into PdbMedicines (ClinicId,Name) values (4,'Desyrel');
insert into PdbMedicines (ClinicId,Name) values (4,'Lexapro');
insert into PdbMedicines (ClinicId,Name) values (4,'Cymbalta');
insert into PdbMedicines (ClinicId,Name) values (4,'Wellbutrin');
insert into PdbMedicines (ClinicId,Name) values (4,'Effexor');
insert into PdbMedicines (ClinicId,Name) values (4,'Valium');
insert into PdbMedicines (ClinicId,Name) values (4,'Paxil');
insert into PdbMedicines (ClinicId,Name) values (4,'Seroquel');
insert into PdbMedicines (ClinicId,Name) values (4,'Risperdal');
insert into PdbMedicines (ClinicId,Name) values (4,'Vyvanse');
insert into PdbMedicines (ClinicId,Name) values (4,'Concerta');
insert into PdbMedicines (ClinicId,Name) values (4,'Abilify');
insert into PdbMedicines (ClinicId,Name) values (4,'Buspar');
insert into PdbMedicines (ClinicId,Name) values (4,'Vistaril');
insert into PdbMedicines (ClinicId,Name) values (4,'Amphetamine');
insert into PdbMedicines (ClinicId,Name) values (4,'Zyprexa');
insert into PdbMedicines (ClinicId,Name) values (4,'Methylphenidate');
insert into PdbMedicines (ClinicId,Name) values (4,'Pristiq');
...
insert into PdbRooms (ClinicId,Name,Building,Floor,Room)
select 4 ClinicId,'Building '+right('0' + cast(Building as nvarchar(max)),2)+', Floor '+right('0' + cast(Floor as nvarchar(max)),2)+', Room '+right('0' + cast(Room as nvarchar(max)),2) Name,Building,Floor,Room
from (select top 2 row_number() over (order by number) Building from master..spt_values) Buildings
join (select top 10 row_number() over (order by number) Floor from master..spt_values) Floors on 1=1
join (select top 10 row_number() over (order by number) Room from master..spt_values) Rooms on 1=1;
...
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Patrice','ONeal','patrice.oneal@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Dana','Carvey','dana.carvey@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Denis','Leary','denis.leary@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Howie','Mandel','howie.mandel@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Katt','Williams','katt.williams@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Jeff','Foxworthy','jeff.foxworthy@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Mike','Birbiglia','mike.birbiglia@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Hannibal','Buress','hannibal.buress@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Wanda','Sykes','wanda.sykes@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Billy','Connolly','billy.connolly@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Rowan','Atkinson','rowan.atkinson@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (4,'Larry','David','larry.david@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'George','Burns','george.burns@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Jimmy','Fallon','jimmy.fallon@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Groucho','Marx','groucho.marx@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Dennis','Miller','dennis.miller@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Jimmy','Carr','jimmy.carr@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Tracy','Morgan','tracy.morgan@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Martin','Lawrence','martin.lawrence@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Woody','Allen','woody.allen@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Doug','Stanhope','doug.stanhope@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Bill','Engvall','bill.engvall@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Demetri','Martin','demetri.martin@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (5,'Kevin','James','kevin.james@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Carol','Burnett','carol.burnett@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Gilbert','Gottfried','gilbert.gottfried@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Jack','Benny','jack.benny@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Ray','Romano','ray.romano@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'David','Letterman','david.letterman@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Tim','Allen','tim.allen@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Lou','Costello','lou.costello@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Jim','Norton','jim.norton@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Lily','Tomlin','lily.tomlin@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Anthony','Jeselnik','anthony.jeselnik@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Drew','Carey','drew.carey@partitiondb.com');
insert into PdbPatients (ClinicId,FirstName,LastName,EMail) values (6,'Eddie','Griffin','eddie.griffin@partitiondb.com');
